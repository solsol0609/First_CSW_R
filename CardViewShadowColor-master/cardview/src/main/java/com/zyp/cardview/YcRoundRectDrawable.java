...
class YcRoundRectDrawable extends Drawable {
    ...
    public YcRoundRectDrawable(int backgroundColor, float radius) {
    ...
    private void updateBounds(Rect bounds) {
        ...
        mBoundsI.set(bounds);
        if (mInsetForPadding) {
            float vInset = YcRoundRectDrawableWithShadow.calculateVerticalPadding(mPadding, mRadius, mInsetForRadius);
            float hInset = YcRoundRectDrawableWithShadow.calculateHorizontalPadding(mPadding, mRadius, mInsetForRadius);
