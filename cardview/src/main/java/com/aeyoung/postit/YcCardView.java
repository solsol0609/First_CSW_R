...
//        } else
    ...
    public YcCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public YcCardView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private final YcCardViewDelegate mCardViewDelegate = new YcCardViewDelegate() {
        ...
        public void setShadowPadding(int left, int top, int right, int bottom) {
            ...
            YcCardView.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                YcCardView.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                YcCardView.super.setMinimumHeight(height);
            }
        }
