...
class YcRoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    YcRoundRectDrawableWithShadow(Resources resources, int backgroundColor, float radius,
        ...
        if (startShadowColor != 0) {
            ...
            mShadowStartColor = resources.getColor(R.color.yc_cardview_shadow_start_color);
        }
        if (endShadowColor != 0) {
